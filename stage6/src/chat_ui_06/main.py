"""
Stage 6: A skills picker in the sidebar
========================================
Adds the /skills HTTP endpoint plus a 'load_skill' control message
over the WebSocket. The browser sidebar shows clickable skill buttons.

Run:
    uvicorn main:app --reload

Make sure you have some .md files in skills/, e.g.:
    skills/HUMANIZER.md
...
class Agent:
    ...
    def build_messages_for_model(self):
        """Inject the active skill as a system message at the top, if any."""
...
def chat():
    ...
    async def _serve():
        config = uvicorn.Config("chat_ui_06.main:app", host="127.0.0.1", port=8000)
