"""
Stage 4: Streaming thinking and content to the browser
=======================================================
The WebSocket now streams Ollama's output to the browser in real time,
with separate event types for thinking, content, tool calls, and tool
results.
...
def chat():
    ...
    async def _serve():
        config = uvicorn.Config("chat_ui_04.main:app", host="127.0.0.1", port=8000)
